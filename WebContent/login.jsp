...
<body>
	...
	<div class="full">
      ...
      <div id="box" style="text-align:center; overflow:auto;">
		<form id="loginForm" onsubmit="return login();" action="login.action" method="post" >
			<p class="main">
			    <div style="position:absolute; right:40%">
				<label style="color:white;">用户名: </label>
			    <input name="username" type="text" id="uName" class="inputshadow"/> 
			    </div>
				<br/><br/>
				<div style="position:absolute; right:40%">
				<label style="color:white;">密码:&nbsp; </label>
				<input type="password" name="password" id="uPass" class="inputshadow"/>	
				</div>
			<br><br>
		  <div class="div2"  style="padding-left:210px" >
			...
			<div style="position:absolute; right:40%">
				<input type="submit" value="登录" class="blue-button" style="cursor: pointer;"/>
	<!-- 			<input type="reset" value="重置" class="blue-button" style="cursor: pointer;"/> -->
			</div>
			</form>
		</div>
